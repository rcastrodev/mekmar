...
class SectionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /** Ordernador de produccion */ 
        Section::create(['page_id' => Page::where('name', 'ordernador-de-produccion')->first()->id, 'name' => 'section_1']);
        Section::create(['page_id' => Page::where('name', 'ordernador-de-produccion')->first()->id, 'name' => 'section_2']);
        Section::create(['page_id' => Page::where('name', 'ordernador-de-produccion')->first()->id, 'name' => 'section_3']);
    }
}
